package com.bigbang.haruharu.config.docs;
...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI(@Value("OpenAPI") String appVersion) {
        Info info = new Info().title("HARU-HARU API").version(appVersion)
                .description("Spring Boot를 이용한 HARU-HARU 웹 애플리케이션 API입니다.")
